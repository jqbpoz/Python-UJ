...
screen.setup(width=800, height=720)  # Mniejsze okno: szerokość=800, wysokość=600
...
def draw_lissajous():
    ...
    t.clear()
    dot.clear()
    current_color = random.choice(["cyan", "magenta","white" ,"yellow", "green", "blue", "red", "orange", "purple", "pink"])
